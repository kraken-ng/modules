...
public class Module_impersonate
{
    ...
    private string[] doImpersonate(string domain, string username, string password)
    {
        string result = "";
        ...
        try
        {
            ...
            result += "Impersonated user: '" + domain + "\\" + username + "' with Token: '" + iToken.ToInt32().ToString() + "'" + Environment.NewLine;
        }
        catch(Exception ex)
        {
    ...
    public string[] execute(string[] args)
    {
        ...
        return doImpersonate(nargs[0], nargs[1], nargs[2]);
    }
    ...
    {
        Module_impersonate m = new Module_impersonate();
