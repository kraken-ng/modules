...
class Module_enum_disabled_functions
{
    private $SUCC_CODE        = 0;
    private $ERR_CODE         = 1;
    ...
    public function execute($args)
    {
        ...
        try
        {
            $result = $this->doEnumDisabledFunctions();
        }
        catch (Exception $e)
        {
...
$cwd = '#{CWD}';
$args = '#{ARGS}';
$module = new Module_enum_disabled_functions($cwd);
