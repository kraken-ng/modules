...
class Module_enum_loaded_extensions
{
    private $SUCC_CODE        = 0;
    private $ERR_CODE         = 1;
    ...
    public function execute($args)
    {
        ...
        try
        {
            $result = $this->doEnumLoadedExtensions();
        }
        catch (Exception $e)
        {
...
$cwd = '#{CWD}';
$args = '#{ARGS}';
$module = new Module_enum_loaded_extensions($cwd);
