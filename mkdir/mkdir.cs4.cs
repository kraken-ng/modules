...
public class Module_mkdir
{
    ...
    private string[] doMkdir(string[] filepaths)
    {
        string result = "";
        ...
        try
        {
            ...
            {
                string normalized_filepath = normalizePath(filepath);

                if(Directory.Exists(normalized_filepath))
                {
                    result += "Directory: '" +  normalized_filepath + "' already exists." + Environment.NewLine;
                    continue;
                }

                Directory.CreateDirectory(normalized_filepath);
                result += "Directory: '" +  normalized_filepath + "' was created." + Environment.NewLine;
            }
        }
        catch(Exception ex)
        {
    ...
    {
        Module_mkdir m = new Module_mkdir();
